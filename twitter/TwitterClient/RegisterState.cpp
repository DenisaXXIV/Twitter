...
void RegisterState::initButtons(sf::RenderTarget* target)
{
	...
	this->m_labels.Username = new Button(100, 80, 20, 20, &this->m_font,
	...
	this->m_labels.Name = new Button(100, 130, 20, 20, &this->m_font,
	...
	this->m_labels.Bio = new Button(100, 230, 20, 20, &this->m_font,
	...
	this->m_labels.Birthday = new Button(100, 290, 20, 20, &this->m_font,
	...
	this->m_labels.Website = new Button(100, 390, 20, 20, &this->m_font,
	...
	this->m_labels.Location = new Button(100, 450, 20, 20, &this->m_font,
